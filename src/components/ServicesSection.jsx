...
export default function ServicesSection({ onSelectService, onBookConsultation, onViewCaseStudy }) {
  ...
  // 9 Website Types provided by the user (Prices reduced by 45%)
  const websiteTypesCatalog = [
    ...
    },
    {
      ...
      pkrRange: '110,000 – 330,000 PKR',
      usdRange: '$1,375 – $3,850',
      pkrMin: 110000,
      pkrMax: 330000,
      usdMin: 1375,
      usdMax: 3850,
    ...
    },
    {
      ...
      pkrRange: '99,000 – 275,000 PKR',
      usdRange: '$1,210 – $3,575',
      pkrMin: 99000,
      pkrMax: 275000,
      usdMin: 1210,
      usdMax: 3575,
    ...
    },
    {
      ...
      pkrRange: '220,000 – 660,000+ PKR',
      usdRange: '$1,925 – $6,600+',
      pkrMin: 220000,
      pkrMax: 660000,
      usdMin: 1925,
      usdMax: 6600,
  ...
  // Exact Customization Add-ons from User Specification (Prices reduced by 45%)
  ...
  // 4 Digital Marketing Packages Catalog (Prices reduced by 45%)
  const marketingPackagesCatalog = [
    ...
    },
    {
      ...
      pkrRange: '60,500 – 143,000 PKR/mo',
      usdRange: '$605 – $1,430/mo',
      pkrMin: 60500,
      pkrMax: 143000,
      usdMin: 605,
      usdMax: 1430,
  ...
  // 4 Graphic Designing & Brand Identity Packages Catalog (Prices reduced by 45%)
  ...
  // 4 Maintenance Retainers & 24/7 SLA Packages Catalog (Prices reduced by 45%)
  const maintenanceCatalog = [
    ...
    },
    {
      ...
      pkrRange: '44,000 – 121,000 PKR/mo',
      usdRange: '$440 – $1,210/mo',
      pkrMin: 44000,
      pkrMax: 121000,
      usdMin: 440,
      usdMax: 1210,
