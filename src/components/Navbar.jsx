...
export default function Navbar({ activePage, onNavigate, onRequestProposalClick }) {
  ...
  return (
    <header className="sticky top-2 z-50 max-w-6xl mx-4 sm:mx-auto px-4 sm:px-6 py-3 rounded-2xl bg-white/90 backdrop-blur-md border border-sky-200/60 shadow-md shadow-sky-500/5 transition-all duration-300">
      <div className="flex items-center justify-between">
        {/* Left: VOLEN SOLUTION branding */}
        <a
          href="#home"
        ...
        {/* Center Nav Links */}
        <nav className="hidden md:flex items-center gap-1 bg-slate-100/70 p-1.5 rounded-xl border border-slate-200/50 overflow-x-auto">
          {navLinks.map((link) => {
